...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 14, 2026 at 06:42 AM
...
--
-- Dumping data for table `category_stockout`
--

INSERT INTO `category_stockout` (`category_id`, `category`) VALUES
(1, 'Damaged'),
(2, 'Expired'),
(3, 'Missing');
...
INSERT INTO `employee` (`employee_id`, `name`, `gender_id`, `date_of_birth`, `hea_id`, `civil_status_id`, `contact_no`, `address`, `role_id`, `date_hired`, `status_id`, `created_at`) VALUES
(1, 'Owner Account', 1, '1990-01-01', 2, 1, '09000000001', 'N/A', 2, '2026-02-15', 1, '2026-02-15 20:58:33'),
(2, 'Senior Staff Account', 2, '1995-01-01', 2, 1, '09000000002', 'N/A', 2, '2026-02-15', 1, '2026-02-15 20:58:33'),
(3, 'Employee Account', 1, '2000-01-01', 2, 1, '09000000003', 'N/A', 1, '2026-02-18', 1, '2026-02-18 19:37:02');
...
--
-- Dumping data for table `highest_educational_attainment`
--

INSERT INTO `highest_educational_attainment` (`hea_id`, `hea_title`) VALUES
(1, 'HS'),
(2, 'College'),
(3, 'GS');
...
(1, 'Value Burger Buns 10s', 'pcs', 0.00, 1017, 50, 1),
(2, 'Double Minute Burger Buns', 'pcs', 0.00, 170, 50, 1),
(3, 'Value Patty', 'pcs', 0.00, 926, 50, 1),
(4, 'Chicken Patty', 'pcs', 0.00, 79, 50, 1),
(5, 'Super Dressing', 'ml', 0.00, 420, 50, 1),
(6, 'Cheesy Dressing', 'ml', 0.00, 96, 50, 1),
(7, 'Chicken Dressing', 'ml', 0.00, 134, 50, 1),
(8, 'Brioche Burger Buns', 'pcs', 0.00, 502, 50, 1),
...
(13, 'Chimichurri Sauce 20s', 'ml', 0.00, 70, 50, 1),
(14, 'Pickled Onions', 'pcs', 0.00, 72, 50, 1),
(15, 'Veggie Patty 20s', 'pcs', 0.00, 57, 50, 1),
(16, 'Honey Mustard Sauce 20s', 'ml', 0.00, 58, 50, 1),
(17, 'Veggie Cabbage 20s', 'pcs', 0.00, 58, 50, 1),
(18, 'Premium Patty', 'pcs', 0.00, 248, 50, 1),
(19, 'Beef Bacon Ultimate', 'pcs', 0.00, 82, 50, 1),
...
(24, 'Grilled Black Pepper Sauce', 'ml', 0.00, 202, 50, 1),
(25, 'Chili Cheese Sauce', 'ml', 0.00, 52, 50, 1),
...
INSERT INTO `orders` (`order_id`, `customer_id`, `employee_id`, `order_date`, `total_amount`, `discount`) VALUES
(6, NULL, 1, '2026-02-15', 93.00, NULL),
(7, NULL, 1, '2026-02-15', 104.00, NULL),
(8, NULL, 2, '2026-02-15', 93.00, NULL),
(11, NULL, 3, '2026-02-18', 93.00, NULL),
(12, NULL, 3, '2026-02-18', 466.00, NULL),
(13, NULL, 3, '2026-02-18', 93.00, NULL),
(14, NULL, 3, '2026-02-18', 93.00, NULL),
(15, NULL, 3, '2026-02-19', 104.00, NULL);
...
INSERT INTO `order_details` (`order_id`, `product_id`, `discount`, `price`, `quantity`, `sub_total`) VALUES
(6, 1, NULL, 41.00, 1, 41.00),
(6, 2, NULL, 52.00, 1, 52.00),
(7, 2, NULL, 52.00, 1, 52.00),
(7, 3, NULL, 52.00, 1, 52.00),
(8, 1, NULL, 41.00, 1, 41.00),
(8, 2, NULL, 52.00, 1, 52.00),
(11, 1, NULL, 41.00, 1, 41.00),
(11, 2, NULL, 52.00, 1, 52.00),
(12, 11, NULL, 99.00, 1, 99.00),
(12, 12, NULL, 86.00, 1, 86.00),
(12, 13, NULL, 96.00, 2, 192.00),
(12, 14, NULL, 89.00, 1, 89.00),
(13, 1, NULL, 41.00, 1, 41.00),
(13, 2, NULL, 52.00, 1, 52.00),
(14, 1, NULL, 41.00, 1, 41.00),
(14, 2, NULL, 52.00, 1, 52.00),
(15, 2, NULL, 52.00, 1, 52.00),
(15, 3, NULL, 52.00, 1, 52.00);
...
ALTER TABLE `employee`
  ...
  ADD KEY `idx_employee_status` (`status_id`),
...
ALTER TABLE `employee_attendance`
  ...
  ADD KEY `idx_att_emp_open` (`employee_id`,`clock_out`);
...
--
ALTER TABLE `stockout`
  MODIFY `stockout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `employee_attendance`
  ADD CONSTRAINT `fk_att_emp` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`);
